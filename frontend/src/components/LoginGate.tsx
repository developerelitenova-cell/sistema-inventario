...
const LoginGate = ({ children }: LoginGateProps) => {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', alignItems: 'center', justifyContent: 'center' }}>
      <ThreeBackground />
      <form onSubmit={handleSubmit} style={{ width: '100%', maxWidth: '360px', textAlign: 'center', position: 'relative', zIndex: 10, background: 'white', borderRadius: '12px', border: '1px solid #e2e8f0', color: '#1e293b', padding: '32px', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)' }}>
